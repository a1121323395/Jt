...
public class HttpClientConfig {
	...
	public PoolingHttpClientConnectionManager getPoolingHttpClientConnectionManager() {
		...
		manager.setMaxTotal(maxTotal);  //设定最大链接数1000
		manager.setDefaultMaxPerRoute(defaultMaxPerRoute);  //设定并发链接数20
		return manager;
	}
	...
	public RequestConfig.Builder getBuilder(){
		...
		return builder.setConnectTimeout(connectTimeout)//5000
				.setConnectionRequestTimeout(connectionRequestTimeout)//500
				.setSocketTimeout(socketTimeout)//5000
				.setStaleConnectionCheckEnabled(staleConnectionCheckEnabled);//true
	}
